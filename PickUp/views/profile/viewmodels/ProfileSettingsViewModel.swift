...
class ProfileSettingsViewModel: ObservableObject {
    ...
    func updateProfile() {
        let input = UpdateUserInput(firstName: !firstName.isEmpty ? firstName : nil, id: AppState.shared.authId! , lastName: !lastName.isEmpty ? lastName : nil, photoUrl: nil, username: !username.isEmpty ? username : nil)
